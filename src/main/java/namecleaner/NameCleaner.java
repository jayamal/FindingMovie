 ...
 * Last Modified Date: 9/4/16 2:11 PM
 * File: namecleaner.NameCleaner
 *
...
public class NameCleaner {
        ...
        synchronized (mstoplist) {
            ...
            if (stoplist == null || cleanlist == null) {
                ...
                cleanlist = new Pattern[]{
                        extensions, bracket, releaseGroup, videoSource, videoFormat, resolution, blacklist, customBlacklist
                };
    ...
    public static String getCleanerProperty(String key) {
        return ResourceBundle.getBundle(NameCleaner.class.getName(), Locale.getDefault()).getString(key);
    }
